...
import { setCookieConsent } from "@/providers/posthog";
    ...
    <div className="fixed inset-x-4 bottom-4 z-50 mx-auto max-w-screen-sm">
      <div className="rounded-md border bg-background px-4 py-3 shadow-lg">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-sm">
            เรามีการใช้คุกกี้ที่มีความจำเป็นอย่างยิ่ง หรือเพื่อการทำงานของเว็บไซต์ และเครื่องมืออื่นๆ
            เพื่อช่วยเพิ่มประสบการณ์การใช้งานให้แก่คุณ
            <Link
              href="/legal/cookies"
              className={cn(buttonVariants({ variant: "link" }), "inline-flex h-fit w-fit p-0")}
            >
              เรียนรู้เพิ่มเติม.
            </Link>
          </p>
