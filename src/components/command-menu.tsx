  ...
  return (
    <React.Fragment>
      <Button
        variant="outline"
        className={cn(
          "relative h-8 w-full justify-start rounded-lg bg-muted/50 text-sm font-normal text-muted-foreground shadow-none sm:pr-12 md:w-40 lg:w-56 xl:w-64"
        )}
        onClick={() => {
          return setOpen(true);
        }}
                    ...
                    >
                      <div className="flex h-full w-full">
                        ...
                        <div className="flex h-full w-full flex-1 flex-col gap-y-4">
                          <span className="block text-sm font-medium">{navItem.title}</span>
